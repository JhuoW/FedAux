...
def split_train(data, dataset, data_path, ratio_train, mode, n_clients):
    ...
    torch_save(os.path.join(data_path, f'{dataset}_{mode}/{n_clients}'), 'train.pt', {'data': data})
    torch_save(os.path.join(data_path, f'{dataset}_{mode}/{n_clients}'), 'test.pt', {'data': data})
    torch_save(os.path.join(data_path, f'{dataset}_{mode}/{n_clients}'), 'val.pt', {'data': data})
